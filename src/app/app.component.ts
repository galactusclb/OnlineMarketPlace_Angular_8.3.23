...
export class AppComponent implements OnDestroy{
  ...
  constructor(private _cart: CartService, private _auth:AuthService,private _prod:ProductsService,private _router:Router){
  ...
  searchProductRoute(){
    this._router.navigate(['/catalogsearch'] , { queryParams: { q : this.searchingDetails['title'] } } )  
  }
}
